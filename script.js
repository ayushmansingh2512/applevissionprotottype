function loco() {
  ...
  ScrollTrigger.scrollerProxy("#main", {
      ...
      // No need for scrollLeft since we are only scrolling vertically
      ...
      // Detect mobile behavior and use "fixed" pinning if necessary
...
// GSAP ScrollTrigger for video autoplay on scroll
gsap.to("#page>video", {
  scrollTrigger: {
      trigger: "#page>video",
      start: "2% top",
      end: "bottom top",
      markers: false,  // Enable markers to check start/end points
      scrub: true,    // Smooth scrolling playback
      scroller: "#main",  // Ensure this matches the scroll container
  },
  onStart: () => {
...
// ScrollTrigger for pinning the #page section
gsap.to('#page', {
  scrollTrigger: {
    trigger: "#page",
    start: "top top",
...
// ScrollTrigger for fading out #page-bottom
gsap.to('#page-bottom', {
  scrollTrigger: {
    trigger: "#page-bottom",
    start: "3% top",
